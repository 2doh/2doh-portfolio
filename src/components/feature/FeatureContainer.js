  ...
  return (
    <Container>
      <HeaderSection>
        ...
        <p>기능적 완성도와 사용자 경험을 고민하며 구현한 기술 모음입니다.</p>
      </HeaderSection>

      <FeatureGrid>
        {featureData.map(item => (
          <FeatureCard key={item.id} bgColor={item.color}>
...
const HeaderSection = styled.div`
  ...
  h2 {
    ...
    font-weight: 900;
    margin-bottom: 16px;
    background: linear-gradient(135deg, #222, var(--color-accent-mint));
...
const FeatureCard = styled.div`
  ...
  .card-top {
    ...
    .main-tag {
      ...
      background: rgba(153, 170, 140, 0.1);
      padding: 6px 12px;
      border-radius: 8px;
    }
